...
########### CP 28/05/2019: Tried standardization instead of centering, removed unnecessary plots
###########################################################################################################
...
DB=read.table("../comparisonGranger_vs_CCM_2species/veilleux_subset.txt",sep="")
time=DB[,1]
...
DB=read.table("../comparisonGranger_vs_CCM_2species/veilleux_subset_CC05a.txt",sep="")
time=DB[,1]
x=log(DB[,2]) #prey # also done with non-log transformed data. 
y=log(DB[,3]) #predator
#Plot data 
