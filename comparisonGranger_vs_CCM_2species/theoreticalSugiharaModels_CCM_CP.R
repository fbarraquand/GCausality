...
pdf("just_trying.pdf",width=12,height=6)
...
lines(sp1_xmap_sp2_means$lib_size, sp1_xmap_sp2_means$rho + 2*sp1_xmap_sp2_means$sd.rho, col = "red",
      lty = 2, lwd = 2)
lines(sp1_xmap_sp2_means$lib_size, sp1_xmap_sp2_means$rho - 2*sp1_xmap_sp2_means$sd.rho, col = "red",
      lty = 2, lwd = 2)
lines(sp2_xmap_sp1_means$lib_size, sp2_xmap_sp1_means$rho + 2*sp2_xmap_sp1_means$sd.rho, col = "blue",
      lty = 2, lwd = 2)
lines(sp2_xmap_sp1_means$lib_size, sp2_xmap_sp1_means$rho - 2*sp2_xmap_sp1_means$sd.rho, col = "blue",
      lty = 2, lwd = 2)
