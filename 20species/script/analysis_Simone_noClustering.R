...
pdf(file = "../figures/ROC_Simone_BIC_noClustering_woutIntraSpInteractions_woutBHcorrection.pdf",width=16,height = 8)
...
write.csv(scoresClassif,file="../results/withoutIntraSp/noClustering/scoresClassif.csv")
write.csv(scores_pGC,file="../results/withoutIntraSp/noClustering/scores_pGC.csv")
